...
module.exports = {
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'JUGGRUSER BOT' : process.env.BOT_NAME,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'JUGGRU' : process.env.TAG_HEADER,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '919656813724,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {

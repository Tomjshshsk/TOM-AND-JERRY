...
r_text[1] = "JUGGRU NE tholpikkaan ningalkavilla. Jeevitathil Amal tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "JUGGRU says i love you 😘";
r_text[3] = "JUGGRUSERdeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "JUGGRUSER - eva - blind juggru \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per juggruser ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than juggruser";
...
r_text[13] = ".song adich thangalude fav song name para juggruser ath download aakki theraam";
...
r_text[18] = "enikk njan und juggruser uyir";
r_text[19] = "\n eda sathyam para nee ente fan alle..\n ";
r_text[20] = "The coefficient's of linear expansions is the position of Haemoglobin in the atmosphere. But Why? Full Many gem of purests serene lay underneath the unfathomed ocean's unblossomeds ! But why? But why ok bie";
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe juggruser pazhaya JUGGRUSER thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik juggruser";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. JUGGRUSER";
